  ...
  causes: [
    {
      ...
      urgency_level: "High",
      short_description:
        "Providing laptops, tablets, and internet connectivity to 500 students in Gaza.",
      image_url:
        "https://placehold.co/600x400/3498db/ffffff?text=Education+For+Gaza",
    ...
    },
    {
      ...
      short_description:
        "Establishing a modern vocational training center in Zarqa for 200 unemployed youth.",
      image_url:
        "https://placehold.co/600x400/2ecc71/ffffff?text=Youth+Skills",
      ...
      impact_metrics: {
        beneficiaries: 200,
        metric_description: "youth will gain technical skills for employment",
      },
    },
    {
      id: 3,
      ...
      urgency_level: "High",
      short_description:
        "Drought-resistant seeds and modern irrigation for 100 local farms.",
      ...
      impact_metrics: {
        beneficiaries: 100,
        metric_description: "farms will increase crop yield by 30%",
      },
    },
    {
      id: 4,
      ...
      urgency_level: "Medium",
      short_description:
        "Empowering female-led startups with seed funding and business mentorship.",
      ...
      impact_metrics: {
        beneficiaries: 50,
        metric_description: "women-led businesses will be launched",
      },
    },
    {
      id: 5,
      ...
      urgency_level: "High",
      short_description:
        "Installing water purification systems in 10 villages across the region.",
      image_url:
        "https://placehold.co/600x400/1abc9c/ffffff?text=Clean+Water",
      ...
      impact_metrics: {
        beneficiaries: 5000,
        metric_description: "people will have access to clean drinking water",
      },
    },
    {
      id: 6,
      ...
      short_description:
        "Providing warm clothing, blankets, and heating fuel for displaced families.",
      image_url:
        "https://placehold.co/600x400/34495e/ffffff?text=Winter+Aid",
      ...
      impact_metrics: {
        beneficiaries: 1000,
        metric_description: "families will receive essential winter supplies",
      },
    },
    {
      id: 7,
      ...
      urgency_level: "Medium",
      short_description:
        "Providing education, healthcare, and support for orphaned children.",
      image_url:
        "https://placehold.co/600x400/e74c3c/ffffff?text=Child+Care",
      location: { city: "Amman", country: "Jordan" },
      metrics: {
        goal_amount: 250000,
      ...
      impact_metrics: {
        beneficiaries: 250,
        metric_description: "children will receive comprehensive care",
      },
    },
    {
      id: 8,
      ...
      urgency_level: "Low",
      short_description:
        "Funding the reconstruction of homes damaged by conflict.",
      image_url:
        "https://placehold.co/600x400/7f8c8d/ffffff?text=Rebuilding",
      location: { city: "Gaza", country: "Palestine" },
      metrics: {
        goal_amount: 125000,
        raised_amount: 125000,
      ...
      impact_metrics: {
        beneficiaries: 40,
        metric_description: "families will have their homes rebuilt",
      },
    },
  ],
};
...
const DollarSignIcon = () => (
  ...
  >
    <path
      ...
      strokeWidth={2}
      d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8v1m0 8v1m0-6.5a1.5 1.5 0 100-3 1.5 1.5 0 000 3z"
    />
  </svg>
);
...
const UsersIcon = () => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.653-.184-1.268-.5-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.653.184-1.268.5-1.857m0 0a5.002 5.002 0 019 0m-4.5-5a3 3 0 100-6 3 3 0 000 6z"
    />
  </svg>
);
  ...
  return (
    <div className="bg-white rounded-2xl overflow-hidden shadow-lg transform hover:-translate-y-2 transition-transform duration-300 ease-in-out flex flex-col">
      <div className="relative">
        ...
        />
        <span
          className={`absolute top-4 left-4 text-xs font-semibold inline-block py-1 px-3 uppercase rounded-full ${urgencyStyles[urgency_level]}`}
        >
      ...
      <div className="p-6 flex flex-col flex-grow">
        ...
        <div className="text-sm text-gray-700 bg-gray-100 rounded-lg p-3 my-4">
          ...
          {impact_metrics.beneficiaries.toLocaleString()}{" "}
          {impact_metrics.metric_description}
        </div>
        ...
        <div className="mb-4">
          <div className="flex justify-between mb-1">
            ...
            <span className="text-sm font-medium text-gray-500">
              {metrics.percentage_funded}%
            </span>
          </div>
          <div className="w-full bg-gray-200 rounded-full h-2.5">
            <div
              className="bg-green-500 h-2.5 rounded-full"
              style={{ width: `${metrics.percentage_funded}%` }}
            ></div>
          </div>
        </div>
    ...
    <div className="bg-gray-50 min-h-screen font-sans">
      <div className="container mx-auto px-4 py-8 md:py-12">
        ...
        <footer className="text-center mt-16 text-gray-500">
          ...
          <p>
            Founded {company_info.founded} | {company_info.headquarters}
          </p>
        </footer>
      </div>
    </div>
